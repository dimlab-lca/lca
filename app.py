#!/usr/bin/env python3
"""
LCA TV - Application Production Finale
Gestion correcte des URLs pour déploiement en sous-répertoire /lca
"""
...
if __name__ == '__main__':
    ...
    print()
    print("🌍 Production URLs (lca-tv.bf):")
    print("   • Site: https://lca-tv.bf/")
    print("   • Vidéos: https://lca-tv.bf/videos")
    print("   • Login: https://lca-tv.bf/login")
    print("   • Dashboard: https://lca-tv.bf/dashboard")
    print("   • Debug: https://lca-tv.bf/debug")
    print("=" * 60)
